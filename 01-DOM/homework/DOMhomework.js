...
creado.innerHTML = 'App creada por AngeloCrack'
...
function agregarVideo(id) {
  var div = document.createElement("div");
  var video = document.createElement("iframe");
  video.src = "https://www.youtube.com/embed/_iafzReTtMQ";
  div.appendChild(video);
  
// Inserta el elemento div con el video debajo del título
  var toDoApp = document.getElementById(id);
  toDoApp.insertAdjacentElement("afterend", div);
}

const toDoApp = () => {
  var toDoAppTitle = document.getElementById("toDoApp");
  toDoAppTitle.addEventListener("click", agregarVideo());
}
